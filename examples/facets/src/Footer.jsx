...
export const Footer = () => {
  return (
    <div className="footer mt-4 border-t p-4 flex flex-row gap-4">
      ...
      <div className="w-64">
        ...
        <p className="text-sm">
          This code sample shows how to render the facets for a search query and
          manage the state as filters are applied to the search results
        </p>
        <div className="my-2 text-sm">
          <a
            target="_blank"
            className="text-slate-500 hover:underline flex flex-row gap-2 items-center"
            href="https://github.com/bloomreach/discovery-web-code-samples/tree/main/examples/facets"
          >
        ...
        <ul className="list-none text-sm">
          ...
          <li className="mb-2">
            <a
              target="_blank"
              className="text-slate-500 hover:underline"
              href="https://documentation.bloomreach.com/discovery/reference/sorting"
            >
              Sorting
            </a>
          </li>
          <li className="mb-2">
            <a
              target="_blank"
              className="text-slate-500 hover:underline"
              href="https://documentation.bloomreach.com/discovery/reference/pagination"
            >
              Pagination
            </a>
          </li>
          <li className="mb-2">
            <a
              target="_blank"
              className="text-slate-500 hover:underline"
              href="https://documentation.bloomreach.com/discovery/reference/faceting-and-filtering"
            >
              Facets &amp; filtering
            </a>
          </li>
          <li className="mb-2">
            <a
                target="_blank"
                className="text-slate-500 hover:underline"
                href="https://documentation.bloomreach.com/discovery/reference/search-use-cases"
            >
              Search use cases
            </a>
          </li>
