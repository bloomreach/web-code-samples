...
export default function App() {
  ...
  function toggleJsonMode(e, value) {
    setShowJson(value === "json");
  }
    ...
    <>
      <div className="bg-[#002840]">
        <div className="max-w-5xl mx-auto flex flex-row p-2 text-slate-300 text-xs items-center">
          ...
          <ToggleButtonGroup
            value={showJson ? "json" : "ui"}
            onChange={toggleJsonMode}
          >
            <ToggleButton className="py-1 px-2 h-auto text-[10px]" value="ui">
              UI
            </ToggleButton>
            <ToggleButton className="py-1 px-2 h-auto text-[10px]" value="json">
              JSON
            </ToggleButton>
          </ToggleButtonGroup>
        </div>
      </div>
      <div className="app p-2 max-w-5xl mx-auto bg-white">
