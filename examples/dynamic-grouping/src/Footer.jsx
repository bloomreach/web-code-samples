  ...
  return (
    <div className="footer mt-4 border-t p-4 flex flex-row gap-4">
      ...
      <div className="w-64">
        ...
        <p className="text-sm">
          This code sample shows the dynamic grouping feature that allows you to
          group similar products together to reduce the size of the recall and
        ...
        <div className="my-2 text-sm">
          <a
            ...
            href="https://github.com/bloomreach/discovery-web-code-samples/tree/main/examples/dynamic-grouping"
          >
