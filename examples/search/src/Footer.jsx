  ...
  return (
    <div className="footer mt-4 border-t p-4 flex flex-row gap-4">
      ...
      <div className="w-64">
        ...
        <p className="text-sm">
          This code sample shows how to setup Bloomreach's search feature with
        ...
        <div className="my-2 text-sm">
          <a
            ...
            href="https://github.com/bloomreach/discovery-web-code-samples/tree/main/examples/search"
          >
