...
export const Footer = () => {
  return <div className="footer mt-4 border-t p-4 flex flex-row gap-4">
    <div className="flex flex-col gap-4 w-80">
      <div className="text-lg font-semibold">
        <img src="/br-experience-discovery-full.svg" className="w-32" />
      </div>
      <p className="text-sm">
    ...
    <div className="w-64">
      ...
      <p className="text-sm">
        This code sample shows the visual search feature to search by
        image
      </p>
      <div className="my-2 text-sm">
        <a
          ...
          href="https://github.com/bloomreach/discovery-web-code-samples/tree/main/examples/visual-search"
        >
      ...
      <ul className="list-none text-sm">
        ...
        <li className="mb-2">
          <a
            target="_blank"
            className="text-slate-500 hover:underline"
            href="https://documentation.bloomreach.com/discovery/docs/visual-search"
          >
            Visual Search
          </a>
        </li>
        <li className="mb-2">
          <a
            target="_blank"
            className="text-slate-500 hover:underline"
            href="https://documentation.bloomreach.com/discovery/reference/visual-search-apis"
          >
            Visual Search API
          </a>
        </li>
