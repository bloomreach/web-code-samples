  ...
  return (
    <div className="footer mt-4 border-t p-4 flex flex-row gap-4">
      ...
      <div className="w-64">
        ...
        <p className="text-sm">
          This code sample shows the relevance by segment feature that allows
          you to rank search results based on segment data to serve different
          experiences to different segments of users.
        </p>
        <div className="my-2 text-sm">
          <a
            target="_blank"
            className="text-slate-500 hover:underline flex flex-row gap-2 items-center"
            href="https://github.com/bloomreach/discovery-web-code-samples/tree/main/examples/relevance-by-segment"
          >
        ...
        <ul className="list-none text-sm">
          ...
          <li className="mb-2">
            <a
              target="_blank"
              className="text-slate-500 hover:underline"
              href="https://documentation.bloomreach.com/discovery/docs/relevance-by-segment"
            >
          ...
          <li className="mb-2">
            <a
              target="_blank"
              className="text-slate-500 hover:underline"
              href="https://documentation.bloomreach.com/discovery/reference/relevance-by-segment-api"
            >
